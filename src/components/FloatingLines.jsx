...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Sem WebGL o fundo fica so com a cor da secao; nada mais quebra.
      console.warn('FloatingLines: WebGL indisponivel, efeito desligado.', err);
      return undefined;
    }
